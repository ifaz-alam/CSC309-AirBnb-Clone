  ...
  const submitForm = async (e) => {
    ...
    if (validateAll()) {
      ...
      try {
        ...
        console.log(user);
        if (response2.ok) {
          localStorage.setItem("Authorization", `Bearer ${data2.access}`);
          ...
          <div className="card w-75 mb-3 mt-3 primary-card-color">
            <div className="card-body">
              <h2 className="card-title text-center mb-3">
                Create a <span className="primary-bold-color">Restify</span>{" "}
                account!
              </h2>
              <form
              ...
              >
                <div className="col-md-10 offset-md-1 mb-3">
                  <label for="email" className="form-label text-center w-100">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div className="col-md-10 offset-md-1 mb-3 email-feedback d-flex justify-content-center">
                  {valid.email === true ? (
                    <div className="good-feedback"> Looks Good </div>
                  ) : (
                ...
                <div className="col-md-10 offset-md-1 mb-3">
                  <label for="phone" className="form-label text-center w-100">
                    Phone Number
                  </label>
                  <input
                    type="text"
                ...
                <div className="col-md-10 offset-md-1 mb-3">
                  <label for="first" className="form-label text-center w-100">
                    First name
                  </label>
                  <input
                    type="text"
                ...
                <div className="col-md-10 offset-md-1 mb-3">
                  <label for="last" className="form-label text-center w-100">
                    Last name
                  </label>
                  <input
                    type="text"
